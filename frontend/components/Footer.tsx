    ...
    <footer className="footer-root" style={{ position: "relative", zIndex: 1, borderTop: "1px solid var(--border)", padding: "26px 56px" }}>
      ...
      <div className="footer-inner" style={{ display: "flex", justifyContent: "space-between", alignItems: "center", maxWidth: 1100, margin: "0 auto" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <img src="/corvo-logo.png?v=2" width={22} height={22} alt="Corvo" style={{ opacity: 0.8 }} />
        ...
        <div style={{ display: "flex", gap: 20, alignItems: "center", flexWrap: "wrap", justifyContent: "center" }}>
          <a href="/blog" className="footer-link" style={{ fontSize: 11, color: "var(--text3)", textDecoration: "none", transition: "color 0.2s" }}>Blog</a>
          <a href="/about" className="footer-link" style={{ fontSize: 11, color: "var(--text3)", textDecoration: "none", transition: "color 0.2s" }}>About</a>
<a href="/pricing" className="footer-link" style={{ fontSize: 11, color: "var(--text3)", textDecoration: "none", transition: "color 0.2s" }}>Pricing</a>
          <a href="/privacy" className="footer-link" style={{ fontSize: 11, color: "var(--text3)", textDecoration: "none", transition: "color 0.2s" }}>Privacy</a>
          <a href="/terms" className="footer-link" style={{ fontSize: 11, color: "var(--text3)", textDecoration: "none", transition: "color 0.2s" }}>Terms</a>
          <a href="/faq" className="footer-link" style={{ fontSize: 11, color: "var(--text3)", textDecoration: "none", transition: "color 0.2s" }}>FAQ</a>
          <a href="/changelog" className="footer-link" style={{ fontSize: 11, color: "var(--text3)", textDecoration: "none", transition: "color 0.2s" }}>Changelog</a>
...
<a href="https://github.com/vinay-batra/corvo" target="_blank" rel="noopener noreferrer" className="footer-link" style={{ fontSize: 11, color: "var(--text3)", textDecoration: "none", transition: "color 0.2s" }}>GitHub</a>
          <a href="https://x.com/corvocapital" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)" className="footer-x-link" style={{ color: "var(--text3)", textDecoration: "none", display: "flex", alignItems: "center", transition: "color 0.2s" }}>
