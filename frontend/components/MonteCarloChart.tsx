        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.35 }}>
          ...
          <Plot
            data={[
              ...
              { x: days, y: data.bands.p95, type: "scatter", mode: "lines", line: { color: "rgba(0,0,0,0)", width: 0 }, showlegend: false, hoverinfo: "skip" } as any,
              { x: days, y: data.bands.p5,  type: "scatter", mode: "lines", fill: "tonexty", fillcolor: "rgba(201,168,76,0.05)", line: { color: "rgba(201,168,76,0.15)", width: 1, dash: "dot" }, showlegend: false } as any,
              ...
              { x: days, y: data.bands.p50, type: "scatter", mode: "lines", line: { color: C.amber, width: 2.5 }, showlegend: false } as any,
            ]}
            layout={{
