...
const POSTS = [
  ...
  },
  {
    ...
    category: "Education",
    categoryColor: "#8eb4c8",
    excerpt: "Running 10,000 simulations of your portfolio's future is the best way to understand your real retirement risk. Here is how it works in plain English.",
  },
  {
          ...
          {CATEGORIES.map((cat) => {
            ...
            return (
              <button
                ...
                onMouseEnter={e => { if (!isActive) { (e.currentTarget as HTMLButtonElement).style.borderColor = "var(--border)"; (e.currentTarget as HTMLButtonElement).style.color = "var(--text2)"; } }}
                onMouseLeave={e => { if (!isActive) { (e.currentTarget as HTMLButtonElement).style.borderColor = "var(--border)"; (e.currentTarget as HTMLButtonElement).style.color = "var(--text3)"; } }}
              >
                {cat}
              </button>
            );
                  ...
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                      <div style={{ width: 22, height: 22, borderRadius: "50%", background: "rgba(201,168,76,0.1)", border: "1px solid rgba(201,168,76,0.2)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                        <img src="/corvo-logo.png?v=2" width={11} height={10} alt="" style={{ opacity: 0.8 }} />
                      </div>
