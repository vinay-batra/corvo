...
const RELATED: RelatedPost[] = [
  ...
  },
  {
    ...
    categoryColor: "#8eb4c8",
    readTime: "6 min read",
    excerpt: "Running 300 simulations of your future is the best way to understand your real retirement risk.",
  },
];
    ...
    >
      ...
      <table>
        ...
        <tbody>
          ...
          <tr><td>Monte Carlo Simulation</td><td>Yes (institutional)</td><td>Yes (300 paths)</td></tr>
