...
export const metadata: Metadata = {
  ...
  description: "Monte Carlo simulation runs 10,000 scenarios of your portfolio's future to show you the real distribution of retirement outcomes. Here is how it works and what to do with the results.",
  ...
  openGraph: {
    ...
    description: "Running 10,000 simulations of your portfolio's future is the best way to understand your real retirement risk.",
...
const TOC: TocItem[] = [
  ...
  { id: "why-10000-paths", title: "Why 10,000 Paths Matter" },
  ...
  { id: "corvo-implementation", title: "How Corvo Runs 10,000 Simulations" },
];
...
export default function MonteCarloPage() {
  return (
    ...
    >
      ...
      <h2 id="why-10000-paths">Why 10,000 Paths (Not Just One) Matters</h2>
      <p>
      ...
      <p>
        Running 10,000 simulations, each with different randomly-ordered return sequences, captures this
      ...
      <p>
        ...
        distribution. 10,000 paths provides strong statistical reliability, giving you a precise probability distribution rather than a rough approximation.
      </p>
      ...
      <h2 id="corvo-implementation">How Corvo Runs 10,000 Simulations</h2>
      <p>
      ...
      <p>
        Corvo generates 10,000 sets of annual returns using the Cholesky decomposition of the correlation
      ...
      <p>
        Each of the 10,000 paths applies your specific position weights, rebalancing assumptions, and any
      ...
      <p>
        Corvo compiles the 10,000 portfolio outcomes into the probability distribution you see in the chart.
