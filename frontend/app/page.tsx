    ...
    "@graph": [
      {
        ...
        screenshot: "https://corvo.capital/og-image.png",
  ...
  return (
    <div ref={containerRef} className="page-fadein" style={{ height: "100vh", overflowY: "auto", overflowX: "hidden", overscrollBehavior: "none", background: "transparent", color: "var(--text)", fontFamily: "Inter,sans-serif" }}>
      ...
      <section className="sec-pad" style={{ position: "relative", zIndex: 1, padding: "0 56px 96px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <Reveal style={{ textAlign: "center", marginBottom: 48 }}>
            <h2 style={{ fontFamily: "Space Mono,monospace", fontSize: "clamp(22px,3vw,36px)", fontWeight: 700, color: "var(--text)", letterSpacing: -1.5, marginBottom: 12 }}>Take Corvo with you</h2>
            <p style={{ fontSize: 15, color: "var(--text2)", fontWeight: 300 }}>Install on any device for instant access and push notifications</p>
          </Reveal>
          <div className="install-cards-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 20 }}>
            {/* iPhone */}
            <Reveal delay={0}>
              <div style={{ background: "var(--card-bg)", border: "1px solid var(--border)", borderRadius: 20, padding: "32px 28px", textAlign: "center" }}>
                <div style={{ display: "flex", justifyContent: "center", marginBottom: 20 }}>
                  <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="1" y="1" width="42" height="42" rx="10" stroke="var(--border2)" strokeWidth="1.5"/>
                    <rect x="8" y="6" width="28" height="32" rx="4" stroke="#c9a84c" strokeWidth="1.4"/>
                    <circle cx="22" cy="34" r="1.5" fill="#c9a84c"/>
                    <path d="M22 14v-4M19 12.5l3-3 3 3" stroke="#c9a84c" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M17 14h10" stroke="#c9a84c" strokeWidth="1.3" strokeLinecap="round"/>
                    <path d="M19 18h6M19 21h6M19 24h4" stroke="var(--text3)" strokeWidth="1.1" strokeLinecap="round"/>
                  </svg>
                </div>
                <div style={{ fontFamily: "Space Mono,monospace", fontSize: 13, fontWeight: 700, color: "var(--text)", letterSpacing: 0.5, marginBottom: 6 }}>iPhone</div>
                <div style={{ fontSize: 11, color: "var(--text3)", marginBottom: 20 }}>Safari required</div>
                <div style={{ textAlign: "left", display: "flex", flexDirection: "column", gap: 10 }}>
                  {[
                    ...
                    <div key={i} style={{ display: "flex", gap: 10, alignItems: "flex-start" }}>
                      <span style={{ fontFamily: "Space Mono,monospace", fontSize: 10, fontWeight: 700, color: "#c9a84c", background: "rgba(201,168,76,0.1)", borderRadius: 4, padding: "2px 6px", flexShrink: 0, marginTop: 1 }}>{i + 1}</span>
            ...
            <Reveal delay={0.08}>
              <div style={{ background: "var(--card-bg)", border: "1px solid var(--border)", borderRadius: 20, padding: "32px 28px", textAlign: "center" }}>
                <div style={{ display: "flex", justifyContent: "center", marginBottom: 20 }}>
                  <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="1" y="1" width="42" height="42" rx="10" stroke="var(--border2)" strokeWidth="1.5"/>
                    <circle cx="22" cy="20" r="9" stroke="#c9a84c" strokeWidth="1.4"/>
                    <path d="M13.5 20h19" stroke="#c9a84c" strokeWidth="1.3" strokeLinecap="round"/>
                    <path d="M22 11v18" stroke="#c9a84c" strokeWidth="1.3" strokeLinecap="round"/>
                    <circle cx="14" cy="15" r="1.5" fill="#c9a84c" opacity="0.5"/>
                    <circle cx="30" cy="15" r="1.5" fill="#c9a84c" opacity="0.5"/>
                    <path d="M10 10.5l3 4M34 10.5l-3 4" stroke="#c9a84c" strokeWidth="1.3" strokeLinecap="round"/>
                    <path d="M17 31h10M19 34h6" stroke="var(--text3)" strokeWidth="1.1" strokeLinecap="round"/>
                  </svg>
                </div>
                <div style={{ fontFamily: "Space Mono,monospace", fontSize: 13, fontWeight: 700, color: "var(--text)", letterSpacing: 0.5, marginBottom: 6 }}>Android</div>
                <div style={{ fontSize: 11, color: "var(--text3)", marginBottom: 20 }}>Chrome required</div>
                <div style={{ textAlign: "left", display: "flex", flexDirection: "column", gap: 10 }}>
                  {[
            ...
            <Reveal delay={0.16}>
              <div style={{ background: "var(--card-bg)", border: "1px solid var(--border)", borderRadius: 20, padding: "32px 28px", textAlign: "center" }}>
                <div style={{ display: "flex", justifyContent: "center", marginBottom: 20 }}>
                  <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <rect x="1" y="1" width="42" height="42" rx="10" stroke="var(--border2)" strokeWidth="1.5"/>
                    <rect x="6" y="10" width="32" height="20" rx="2" stroke="#c9a84c" strokeWidth="1.4"/>
                    <path d="M16 34h12M22 30v4" stroke="#c9a84c" strokeWidth="1.4" strokeLinecap="round"/>
                    <circle cx="34" cy="12" r="2.5" fill="#c9a84c"/>
                ...
                <div style={{ fontFamily: "Space Mono,monospace", fontSize: 13, fontWeight: 700, color: "var(--text)", letterSpacing: 0.5, marginBottom: 6 }}>Desktop</div>
                <div style={{ fontSize: 11, color: "var(--text3)", marginBottom: 20 }}>Chrome or Edge</div>
                <div style={{ textAlign: "left", display: "flex", flexDirection: "column", gap: 10 }}>
                  {[
        ...
        <style>{`
          @media (max-width: 768px) {
            .install-cards-grid { grid-template-columns: 1fr !important; }
          }
        `}</style>
      </section>
