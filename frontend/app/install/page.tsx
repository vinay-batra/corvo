      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        <div className="install-hero" style={{ textAlign: "center" }}>
          ...
          <div style={{ display: "flex", justifyContent: "center", marginBottom: 14 }}>
            <AnimatedHeading text="Take Corvo" accentText="everywhere you go." style={{ fontFamily: "Space Mono, monospace", fontSize: "clamp(32px, 4.4vw, 60px)", fontWeight: 700, color: "var(--text)", letterSpacing: -1.5, lineHeight: 1.12 }} />
          </div>
