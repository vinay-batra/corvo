              ...
              <motion.div key="stocks" initial={false} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -16 }} transition={{ duration: 0.2 }}>
                {stockTicker ? (
                  ...
                  <div>
                    ...
                    <div style={{ marginTop: 24, paddingTop: 20, borderTop: "1px solid var(--border)", display: "flex", flexDirection: "column", alignItems: "center", gap: 10 }}>
                      ...
                      <button
                        ...
                        onMouseEnter={e => { e.currentTarget.style.background = "rgba(var(--accent-rgb),0.14)"; e.currentTarget.style.transform = "translateY(-1px)"; }}
                        onMouseLeave={e => { e.currentTarget.style.background = "rgba(var(--accent-rgb),0.06)"; e.currentTarget.style.transform = "translateY(0)"; }}
                      >
