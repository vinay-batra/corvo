...
- Version: v0.49 (frontend + backend both live; per-account portfolio settings + brief as-of pill + import loading state + first-time PV education modal shipped May 27)
