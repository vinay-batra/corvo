...
**Last shipped: v0.34 (May 16, 2026) - day-over-day portfolio value persistence (Fidelity-style ratcheting), per-account portfolio switcher chip row, 401(k) prompt tightening, health_score_cache account-type partitioning. Frontend + backend + Supabase migration.**
